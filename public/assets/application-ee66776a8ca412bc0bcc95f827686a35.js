...
var FantasyInsiders = angular.module("FantasyInsiders", ['FantasyInsiders.resources', 'FantasyInsiders.services', 'FantasyInsiders.directives', 'FantasyInsiders.filters', 'FantasyInsiders.controllers', 'ui.compat', '$strap.directives']);
FantasyInsiders.constant('apiPrefix', '/api');
FantasyInsiders.constant('sessionStore', '_fantasy_insiders_session');
FantasyInsiders.config(function($httpProvider) {
  $httpProvider.defaults.headers.common['X-CSRF-Token'] = $('meta[name=csrf-token]').attr('content');
});
FantasyInsiders.config(['$locationProvider', function($locationProvider) {
  $locationProvider.html5Mode(true);
}]);
FantasyInsiders.config(function($stateProvider, $urlRouterProvider){
      ...
      .state('default', {
      	...
      	views: {
      		"": {
      				...
      				templateUrl: "/templates/layouts/default.html.erb"
      			}
      		}
      	})
      .state('default', {
      	url: "/login",
      	templateUrl: "/templates/login/index.html.erb",
...
//
FantasyInsiders.config(['$httpProvider', function ($httpProvider) {
