angular.module('FantasyInsiders.resources').factory('UserSession', ['$http', function($http) {
...
//
angular.module('FantasyInsiders.resources').factory('UserRegistration', ['$http', function($http) {
